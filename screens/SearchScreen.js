...
const SearchScreen = () => {
  ...
  return (
    <SafeAreaView>
      <View style ={{margin: 30, padding: 10, flexDirection: 'row',alignItems: 'center',justifyContent: 'space-between', borderColor: "#FFC72C", borderWidth: 4, borderRadius:10 }}>
        <TextInput value={input}
        onChangeText={(text) => setInput(text)}
        placeholder='Enter Your Destination'/>
        <Ionicons name="search" size={22} color="black" />
      </View>
      {/*here we are sending the data and the text that user type to SearchResult Screen */}
